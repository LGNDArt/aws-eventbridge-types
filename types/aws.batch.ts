...
export class Convert {
    public static toAwsBatch(json: string): AwsBatch[] {
        return cast(JSON.parse(json), a(r("AwsBatch")));
    }

    public static awsBatchToJson(value: AwsBatch[]): string {
        return JSON.stringify(uncast(value, a(r("AwsBatch"))), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Detail": o([
        ...
        { json: "jobQueue", js: "jobQueue", typ: "" },
        { json: "status", js: "status", typ: "" },
        { json: "attempts", js: "attempts", typ: a("any") },
        { json: "createdAt", js: "createdAt", typ: 0 },
        { json: "retryStrategy", js: "retryStrategy", typ: r("RetryStrategy") },
        { json: "dependsOn", js: "dependsOn", typ: a("any") },
        { json: "jobDefinition", js: "jobDefinition", typ: "" },
        { json: "parameters", js: "parameters", typ: r("Parameters") },
        { json: "container", js: "container", typ: r("Container") },
    ], false),
    "Container": o([
        { json: "image", js: "image", typ: "" },
        { json: "resourceRequirements", js: "resourceRequirements", typ: a(r("ResourceRequirement")) },
        { json: "command", js: "command", typ: a("") },
        { json: "volumes", js: "volumes", typ: a("any") },
        { json: "environment", js: "environment", typ: a("any") },
        { json: "mountPoints", js: "mountPoints", typ: a("any") },
        { json: "ulimits", js: "ulimits", typ: a("any") },
    ], false),
